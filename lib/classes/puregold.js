                        ...
                        sourceSheet.eachRow({ includeEmpty: false, firstRow: 2 }, (row, rowNumber) => {
                            if (rowNumber > 1 && rowNumber !== undefined) {
                                ...
                                const newRowData = [
                                    ...
                                    row.getCell(22).value, // SKU PER BRAND
                                    row.getCell(23).value, // GENERALIZED SKU
                                    row.getCell(24).value, // MOTHER SKU
                                    row.getCell(25).value, // SALES CATEGORY
                                    row.getCell(26).value, // SKU DEPT
                                    row.getCell(27).value, // PLACEMENT
                                    row.getCell(28).value, // PLACEMENT REMARKS
